...
def load_model(path):
    try:
        ...
        model.load_weights('/content/drive/MyDrive/cars_detection/wpod-net.h5')
...
def extractVehicleInfo(image: UploadFile):
    ...
    if cnt > 0:
        wpod_net_path = "../ml/wpod-net"
        wpod_net = load_model(wpod_net_path)
        img_path = glob.glob(name)
        LpImg,cor = get_plate(img_path[0], wpod_net)
